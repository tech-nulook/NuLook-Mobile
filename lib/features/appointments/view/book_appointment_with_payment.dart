...
class BookAppointmentWithPayment extends StatefulWidget {
  const BookAppointmentWithPayment({super.key});

  @override
  State<BookAppointmentWithPayment> createState() => _BookAppointmentWithPaymentState();
}

class _BookAppointmentWithPaymentState extends State<BookAppointmentWithPayment> {
  @override
